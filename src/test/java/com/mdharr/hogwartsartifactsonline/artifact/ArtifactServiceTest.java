...
class ArtifactServiceTest {
    ...
    void testFindByIdNotFound() {
        ...
        Throwable thrown = catchThrowable(()-> {
            Artifact returnedArtifact = artifactService.findById("1250808601744904192"); // if findById throws an exception, we capture it and assign to thrown variable
        });
    ...
    void testUpdateSuccess() {
        ...
        Artifact artifactUpdate = new Artifact();
        artifactUpdate.setId("1250808601744904192");
        artifactUpdate.setName("Invisibility Cloak-update");
        artifactUpdate.setDescription("A new description.");
        artifactUpdate.setImageUrl("ImageUrl");

        given(artifactRepository.findById("1250808601744904192")).willReturn(Optional.of(oldArtifact));
        given(artifactRepository.save(oldArtifact)).willReturn(oldArtifact);

        // When
        Artifact updatedArtifact = artifactService.update("1250808601744904192", artifactUpdate);

        // Then
        assertThat(updatedArtifact.getId()).isEqualTo(artifactUpdate.getId());
        assertThat(updatedArtifact.getDescription()).isEqualTo(artifactUpdate.getDescription());
